  ...
  return (
    <div>
        ...
        <div className="row px-xl-5 pb-3">
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div className="d-flex align-items-center border mb-4" style={{padding: "23px"}}>
...
<div className="container-fluid pt-5" >
        <div className="row px-xl-5 pb-3">
            ...
            <div className="col-lg-4 col-md-6 pb-1">
                <div className="cat-item d-flex flex-column border mb-4" style={{padding: "30px"}} key={x.id}>
                    <p className="text-right">15 Products</p>
                    <Link  className="cat-img position-relative overflow-hidden mb-3" to={`products/${x.id}`}>
                        <img className="img-fluid" src={x.img}  alt="" />
                    </Link>
                    <h5 className="font-weight-semi-bold m-0">{x.name}</h5>
                </div>
            </div>
             ))}
        </div>
        ...
        <div className="row px-xl-5">
            <div className="col-md-6 pb-4">
                <div className="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                    <img src="http://localhost:3000/imgs/offer-1.png" alt=""/>
                    <div className="position-relative" style={{zIndex: "1"}}>
                        ...
                        <Link href="" className="btn btn-outline-primary py-md-2 px-md-3">Shop Now</Link>
                    </div>
                </div>
            </div>
            <div className="col-md-6 pb-4">
                <div className="position-relative bg-secondary text-center text-md-left text-white mb-2 py-5 px-5">
                    <img src="http://localhost:3000/imgs/offer-2.png" alt=""/>
                    <div className="position-relative" style={{zIndex: "1"}}>
                        <h5 className="text-uppercase text-primary mb-3">20% off the all order</h5>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div className="card product-item border-0 mb-4">
                    ...
                    <div className="card-footer d-flex justify-content-between bg-light border">
                        <Link href="" className="btn btn-sm text-dark p-0"><i className="fas fa-eye text-primary mr-1"></i>View Detail</Link>
                        <Link href="" className="btn btn-sm text-dark p-0"><i className="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</Link>
                    </div>
                </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
